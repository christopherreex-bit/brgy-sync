    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Chronological log of all staff actions across all cases.',
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Search by reference number, staff name, or action',
                ...
                child: Container(
                  ...
                  child: Text(
                    _dateFrom != null
                        ...
                        : 'Date From',
                    style: TextStyle(fontSize: 13, color: _dateFrom != null ? Colors.black : Colors.grey),
                  ),
                ),
              ),
              const SizedBox(width: 8),
                ...
                child: Container(
                  ...
                  child: Text(
                    _dateTo != null
                        ...
                        : 'Date To',
                    style: TextStyle(fontSize: 13, color: _dateTo != null ? Colors.black : Colors.grey),
                  ),
                ),
              ),
            ],
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text('Actions will appear here as staff update cases.',
