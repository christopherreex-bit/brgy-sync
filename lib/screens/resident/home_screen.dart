...
class HomeScreen extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          GridView.builder(
            ...
            itemCount: 6,
            itemBuilder: (context, index) => _buildCard(context, kServiceCategories[index]),
          ),
  ...
  Widget _buildCard(BuildContext context, ServiceCategory cat, {bool isWide = false}) {
    return InkWell(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Select the specific service type:', style: TextStyle(color: Colors.grey.shade600, fontSize: 13)),
            const SizedBox(height: 12),
            ...cat.subTypes.map((st) => ListTile(
                  dense: true,
                  leading: const Icon(Icons.chevron_right, size: 20, color: kNavy),
