...
class ExportService {
  ...
  /// Builds a CSV string and triggers a browser download on web.
  ...
  static Future<void> generateCompliancePdf({
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) [
          pw.Text("Citizens' Charter Compliance Report",
              style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
          pw.SizedBox(height: 4),
          pw.Text('Barangay Calzada-Tipas, Taguig City',
              style: const pw.TextStyle(fontSize: 10, color: PdfColors.grey700)),
          pw.SizedBox(height: 4),
          pw.Text('Period: $month  |  Generated: ${now.month}/${now.day}/${now.year}',
  ...
  static Future<void> generateExpenditurePdf({
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        margin: const pw.EdgeInsets.all(32),
        build: (context) [
          pw.Text('Expenditure Summary Report',
              style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
          pw.SizedBox(height: 4),
          pw.Text('Barangay Calzada-Tipas, Taguig City',
              style: const pw.TextStyle(fontSize: 10, color: PdfColors.grey700)),
          pw.SizedBox(height: 4),
          pw.Text('Generated: ${now.month}/${now.day}/${now.year} ${now.hour}:${now.minute.toString().padLeft(2, '0')}',
              style: const pw.TextStyle(fontSize: 9, color: PdfColors.grey600)),
          pw.Divider(),
